...
- **핵심 성과**:
    - 선행 연구를 참고하여 여러 머신러닝 알고리즘을 사용하여 신용카드 승인 예측 모델을 구축하였고, 모델의 정확도를 95%로 향상시켰습니다. 이를 통해 은행이 신용카드 승인 결정을 내릴 때 보다 정보에 입각한 판단을 할 수 있도록 기여하였습니다.
...
- **핵심 성과**:
    - 다양한 머신러닝 모델을 시도하였고, XGBoost 모델이 가장 높은 성능을 보였습니다. 생성해낸 모델은 데이콘 경진 대회에서 약 400등을 차지하였습니다. 
...
- **핵심 성과**:
  - 선행 연구를 참고하여 전기 생산량 데이터를 수집하고 분석하여 대륙별 및 국가별 추세를 도출하였습니다.
  - 팀원들이 태블로에 익숙하지 않은 상황에서 연구를 통해 방향성을 잡고, 유럽의 전기 에너지 강국 성장 가능성을 예측하는 대시보드를 설계하였습니다.
...
- **핵심 성과**:
    - KNNImputer를 사용하여 결측치를 효과적으로 처리하고 데이터셋을 정제하였습니다. 다양한 머신러닝 모델 평가를 통해 최적 모델로 LightGBM 모델선정하였고 하이퍼파라미터를 최적화하여 성능을 향상시켰습니다.
